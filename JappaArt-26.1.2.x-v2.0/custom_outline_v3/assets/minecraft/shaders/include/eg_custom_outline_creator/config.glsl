...
#ifndef EG_OUTLINES_CONFIG
#define EG_OUTLINES_CONFIG
...
#define block_COLOUR_PERIOD 4.5
#define block_SMOOTHNESS 1
#define block_ANIMATE_WITH_DISTANCE false
...
const uint hc_block_COLOURS[] = uint[](
0xf93d3dffu,
0xf9bb3dffu,
0x79f93dffu,
0x3df9e1ffu,
...
#define hc_block_SMOOTHNESS 0.5
...
const uint hc_block_outer_COLOURS[] = uint[](
0x541212ffu,
0x4c3811ffu,
0x244c12ffu,
0x0e413bffu,
...
#define hc_block_outer_SMOOTHNESS 0
...
const uint hitbox_COLOURS[] = uint[](
0xffffffffu
);
#define hitbox_ANIM_SPEED 700
#define hitbox_COLOUR_PERIOD 3
#define hitbox_SMOOTHNESS 0.5
